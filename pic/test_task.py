...
class TestTask(OkrTest):
	...
	def test_task(self):
		...
		self.send_keys('input.addInp','test_task')
		...
		self.send_keys('css=td.taskInto > div > div > input','xiaji1')
		self.click('css=button.btn_tast')
		self.click('css=td.taskInto > span > b')
		text = self.find_element('css=i.taskTxt').text
 ...
 driver.find_element_by_css_selector('div.leader > input').send_keys('wj')
 ...
 driver.find_element_by_css_selector('span.laydate-btns-now').click()
 driver.find_element_by_css_selector('span.laydate-btns-now').click()
 driver.find_element_by_css_selector('#textarea').send_keys('xiangqing')
 driver.find_element_by_css_selector('body > div.detail > input').click()
		...
		self.send_keys('css=input.name','wj')
